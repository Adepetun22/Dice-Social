...
const InnerChatOption = () => {
  return (
    <div className="rounded-lg flex flex-col gap-0 items-end justify-start w-[175px] relative shadow-md z-50">
      <div className="rounded-lg flex flex-col gap-0 items-start justify-start flex-shrink-0 w-[175px] relative shadow-md">
