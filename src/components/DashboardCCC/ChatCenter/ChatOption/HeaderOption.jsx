...
const HeaderOption = () => {
  return (
    <div className="rounded-lg flex flex-col gap-0 items-end justify-start relative shadow-md z-50">
      <div className="rounded-lg flex flex-col gap-0 items-start justify-start flex-shrink-0 w-[196px] relative shadow-md">
        <div className="bg-white rounded-md p-[10px] flex flex-col gap-2 items-start justify-center self-stretch flex-shrink-0 relative">
          ...
          <div className="flex flex-row gap-2.5 items-center justify-start self-stretch flex-shrink-0 relative cursor-pointer hover:bg-gray-100 p-[6px] rounded">
            <img className="flex-shrink-0 w-5 h-5 relative overflow-visible" src={flagIcon} alt="Flag" />
